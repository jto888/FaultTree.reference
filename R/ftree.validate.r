ftree.validate<-function(DF, ft_node=1) {					
## initial validation code suitable for cutsets and bdd calls on C++					
## mission_time must be in the P2 column of the  top gate node					

## this test is commented out for testing without FaultTree package installed					
